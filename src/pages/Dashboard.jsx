                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem' }}>
                              ...
                              <span style={{ fontWeight: '500', whiteSpace: 'wrap' }} title={task.fileName}>
                                <a href={task.fileName} target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary)', textDecoration: 'underline' }}>
                                  {task.originalName ? (task.originalName.length > 25 ? task.originalName.substring(0, 25) + '...' : task.originalName) : (task.fileName.length > 25 ? task.fileName.substring(0, 25) + '...' : task.fileName)}
                                </a>
                              </span>
                            </div>
